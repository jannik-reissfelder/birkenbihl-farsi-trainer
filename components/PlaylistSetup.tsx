...
const PlaylistSetup: React.FC<PlaylistSetupProps> = ({ levels, onSelectLesson }) => {
  ...
  return (
    <div className="animate-fade-in max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-100">Playlist-Lektion auswählen</h2>
        <p className="text-lg text-gray-400 mt-2">Wähle eine Lektion aus. Alle Sätze bis einschließlich dieser Lektion werden in die Playlist aufgenommen.</p>
      </div>
